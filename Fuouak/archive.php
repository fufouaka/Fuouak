...
<?php $this->need('header.php'); ?>
  ...
  <br>
                  <center><font style="font-size:18px"><b><?php $this->options->title() ?> -- 归档区 </b></font> [文章归档]</center>
<div id="body">
    <div class="container">
        <div>
	<div>
          ...
          <br>
                 <div style="\#header\ \{\ padding-top: 35px;border-bottom: 3px solid #228B22;text-align: center;"></div>
                  ...
                  <br>
                  <span>板块：<a><?php $this->date('F j, Y'); ?></a></span>
                  <br>
...
<div>
  <h4>日期[<a> <?php $this->date('F j, Y'); ?> </a>]下的文章：</h4>
  <ol>
    	<?php while($this->next()): ?>
